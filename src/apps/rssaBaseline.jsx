                    ...
                    <div style={{ margin: "0 3em" }}>
                        ...
                        <Router basename='/rssa'>
                            <Switch>
                                ...
                                <Route path="/raterecommendations1" render={(props) => <RecommendationPageBaseline {...props}
                                    ...
                                    />
                                <Route path="/raterecommendations2" render={(props) => <RecommendationPageBaseline {...props}
                                    progressUpdater={this.progressUpdater} toggleLoader={this.loaderToggler}
                                    ...
                                    />
                                <Route path="/raterecommendations3" render={(props) => <RecommendationPageBaseline {...props}
                                    progressUpdater={this.progressUpdater} toggleLoader={this.loaderToggler}
